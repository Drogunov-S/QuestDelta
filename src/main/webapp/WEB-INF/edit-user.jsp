...
<div class="container">
    <jsp:useBean id="user" scope="request" type="ua.com.javarush.quest.drogunov.quest.dto.ui.UserDto"/>
    <form class="form-horizontal" action="edit-user?id=${user.id}" method="post" enctype="multipart/form-data">
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <input id="userLogin" type="text" placeholder="Set login"
            ...
            <div class="form-group">
                ...
                <div class="col-md-4">
                    <button id="submit" name="${user.id>0?"update":"create"}" class="btn btn-success">
